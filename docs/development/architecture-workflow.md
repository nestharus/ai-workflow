...
This workflow distributes architecture proposal inputs and library-to-component mapping
across per-library GLM agents, aggregates results in Python, and enforces citation
compliance against the library manifest.
...
* Allowed formats: `[LIB-####::charter.md]` and `[LIB-####::spec.md::SECTION]`.
