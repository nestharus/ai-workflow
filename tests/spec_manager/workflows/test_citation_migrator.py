...
class TestEvidenceIndex:
    ...
    def test_build_from_ranges(
        self, sample_evidence_ranges: list[EvidenceRange]
    ) -> None:
        ...
        assert index.by_file_section[("F0001", "SEC-F0001-0001")] == [
            "EVID-F0001-R0001-L1-L10"
        ]
...
class TestMigrateDocumentCitations:
    ...
    def test_migrate_document_with_spec_snapshot(
