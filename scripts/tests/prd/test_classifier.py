"""Tests for scripts.prd.classifier module."""
...
# These private helper functions (_count_indexed_ids, _count_prose_indicators,
# _count_section_headers) implement deterministic heuristics for input classification.
# We test them directly for clarity and regression protection, as their behavior is
# difficult to verify through the public classify_input API alone.
...
class TestCountProseIndicators:
    """Tests for _count_prose_indicators function."""
...
class TestCountSectionHeaders:
    """Tests for _count_section_headers function."""
...
class TestCountIndexedIds:
    """Tests for _count_indexed_ids function."""
...
class TestClassifyByHeuristics:
    """Tests for classify_by_heuristics function."""
