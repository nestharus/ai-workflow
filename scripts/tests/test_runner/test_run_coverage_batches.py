"""Tests for run_coverage_batches.py module.

This module tests the orchestration of parallel test-debugger agents
...
class TestGenerateAgentPrompt:
    """Tests for the generate_agent_prompt function."""
...
class TestRunTestCoverage:
    """Tests for the run_test_coverage function."""
...
class TestRunBatching:
    """Tests for the run_batching function."""
