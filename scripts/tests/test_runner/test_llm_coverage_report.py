"""Tests for scripts.dev.test_runner.llm_coverage_report module."""
...
from scripts.dev.test_runner import llm_coverage_report
from scripts.dev.test_runner.llm_coverage_report import (
    FunctionCoverageGap,
    MissingBranchDetail,
    MissingLineDetail,
    _build_context,
...
class TestScriptModuleWrapper:
    ...
    def test_debug_enabled_returns_false_by_default(self) -> None:
        ...
        with patch.dict("os.environ", {}, clear=True):
            result = llm_coverage_report._debug_enabled()
    ...
    def test_main_handles_non_int_system_exit(self) -> None:
        ...
        with patch.object(
            llm_coverage_report, "_generate_llm_coverage", side_effect=SystemExit("error message")
        ):
            with pytest.raises(SystemExit) as exc_info:
                llm_coverage_report.main()
