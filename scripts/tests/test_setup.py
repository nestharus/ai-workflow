...
class TestMain:
    ...
    def test_returns_returncode_on_subprocess_error(self, capsys: pytest.CaptureFixture) -> None:
    ...
    def test_returns_one_on_generic_runtime_error(self, capsys: pytest.CaptureFixture) -> None:
