...
def test_aggregate_files(temp_db):
...
def test_get_files_with_issues(temp_db):
...
def test_get_files_with_issues_filter(temp_db):
...
def test_get_files_with_issues_limit(temp_db):
...
def test_get_files_with_issues_sort_by_file(temp_db):
