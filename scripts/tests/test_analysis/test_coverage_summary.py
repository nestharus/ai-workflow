...
def test_get_filtered_functions(temp_db):
...
def test_get_filtered_missing_lines(temp_db):
...
def test_aggregate_files_by_coverage(temp_db):
...
def test_generate_summary(temp_db):
...
def test_generate_summary_with_empty_db():
