"""Tests for scripts.dev.linter.linters.scripts module."""
...
class TestScriptsLinterInit:
    """Tests for ScriptsLinter class attributes."""
...
class TestScriptsLinterConfigLoading:
    """Tests for ScriptsLinter.run config loading."""
...
class TestScriptsLinterPyprojectMissing:
    """Tests for ScriptsLinter.run when pyproject.toml missing."""
...
class TestScriptsLinterParsing:
    """Tests for ScriptsLinter.run pyproject.toml parsing."""
...
class TestScriptsLinterFilesIgnored:
    """Tests for ScriptsLinter.run files parameter."""
