"""Tests for scripts.pr.git_dao module.

Tests all git data access operations with mocked subprocess calls.
"""
...
class TestCountCommitsAhead:
    """Tests for count_commits_ahead function."""
...
class TestFetchAllPrune:
    """Tests for fetch_all_prune function."""
...
class TestBranchExistsLocal:
    """Tests for branch_exists_local function."""
...
class TestBranchExistsRemote:
    """Tests for branch_exists_remote function."""
...
class TestFetchOrigin:
    """Tests for fetch_origin function."""
...
class TestCreateWorktreeTracking:
    """Tests for create_worktree_tracking function."""
...
class TestResetHardToRemote:
    """Tests for reset_hard_to_remote function."""
...
class TestCreateSharedClone:
    """Tests for create_shared_clone function."""
...
class TestRemoveSharedClone:
    """Tests for remove_shared_clone function."""
