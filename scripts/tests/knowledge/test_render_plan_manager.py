...
@pytest.fixture
def sample_render_plan_dict() -> dict[str, Any]:
...
class TestValidateRenderPlanSchema:
    ...
    def test_valid_plan_returns_empty_list(self, sample_render_plan_dict: dict[str, Any]) -> None:
    ...
    def test_invalid_render_engine(self, sample_render_plan_dict: dict[str, Any]) -> None:
    ...
    def test_inputs_not_dict(self, sample_render_plan_dict: dict[str, Any]) -> None:
    ...
    def test_inputs_missing_fields(self, sample_render_plan_dict: dict[str, Any]) -> None:
    ...
    def test_inputs_wrong_type(self, sample_render_plan_dict: dict[str, Any]) -> None:
    ...
    def test_determinism_not_dict(self, sample_render_plan_dict: dict[str, Any]) -> None:
    ...
    def test_determinism_missing_ordering(self, sample_render_plan_dict: dict[str, Any]) -> None:
    ...
    def test_steps_not_list(self, sample_render_plan_dict: dict[str, Any]) -> None:
    ...
    def test_step_missing_id(self, sample_render_plan_dict: dict[str, Any]) -> None:
    ...
    def test_step_missing_instruction(self, sample_render_plan_dict: dict[str, Any]) -> None:
