...
class TestLoadRerankerModel:
    """Tests for load_reranker_model function."""
...
class TestLoadRerankerModelActual:
    """Tests that actually call load_reranker_model function (covers lines 117-137)."""
...
class TestScoreCandidatesMain:
    """Tests for score_candidates_main function."""
