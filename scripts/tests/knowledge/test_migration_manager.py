"""Tests for scripts.knowledge.migration_manager module."""
...
class TestAppendTask:
    """Tests for append_task function."""
...
class TestExtractPatternFromPath:
    """Tests for extract_pattern_from_path function."""
...
class TestSaveOriginalWithTimestamp:
    """Tests for save_original_with_timestamp function."""
...
class TestCountUnresolvedDifferences:
    """Tests for count_unresolved_differences function."""
...
class TestGetOriginalFilePath:
    """Tests for get_original_file_path function."""
...
class TestParseStartArgs:
    """Tests for parse_start_args function."""
...
class TestCountUnresolvedDifferencesResultNone:
    """Tests for count_unresolved_differences when DuckDB result is None."""
...
class TestValidateMigrationFull:
    """Tests for validate_migration function covering full execution paths."""
