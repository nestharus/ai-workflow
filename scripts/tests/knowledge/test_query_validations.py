...
class TestMain:
    ...
    def test_lists_validations(
        self, validations_csv: Path, capsys: pytest.CaptureFixture[str]
    ) -> None:
    ...
    def test_stats_output(self, validations_csv: Path, capsys: pytest.CaptureFixture[str]) -> None:
        """Verify stats output."""
        result = main(
            [
                "--validations-csv",
    ...
    def test_json_output(self, validations_csv: Path, capsys: pytest.CaptureFixture[str]) -> None:
