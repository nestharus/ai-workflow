...
@pytest.fixture
def validations_csv(
    fs: FakeFilesystem, sample_validations: list[ValidationResult]
) -> Path:
...
class TestFilterValidations:
    ...
    def test_filter_by_artifact_id(
        self, sample_validations: list[ValidationResult]
    ) -> None:
    ...
    def test_filter_by_min_similarity(
        self, sample_validations: list[ValidationResult]
    ) -> None:
...
class TestFormatTable:
    ...
    def test_formats_validations_as_table(
        self, sample_validations: list[ValidationResult]
    ) -> None:
...
class TestFormatYaml:
    ...
    def test_formats_as_valid_yaml(
        self, sample_validations: list[ValidationResult]
    ) -> None:
...
class TestComputeStats:
    ...
    def test_computes_passed_failed(
        self, sample_validations: list[ValidationResult]
    ) -> None:
    ...
    def test_computes_avg_similarity(
        self, sample_validations: list[ValidationResult]
    ) -> None:
    ...
    def test_computes_by_render_plan(
        self, sample_validations: list[ValidationResult]
    ) -> None:
...
class TestMain:
    ...
    def test_lists_validations(
        self, validations_csv: Path, capsys: pytest.CaptureFixture
    ) -> None:
    ...
    def test_filter_by_passed(
        ...
        result = main([
            "--validations-csv", str(validations_csv),
            "--passed", "false",
        ])
