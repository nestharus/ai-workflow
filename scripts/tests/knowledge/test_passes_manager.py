...
class TestEnsurePassesCsvExists:
    ...
    def test_does_not_overwrite_existing_csv(self, tmp_path: Path) -> None:
        ...
        existing_content = "pass_id,artifact_id,entity_id,entity_mention,span_id,chunk_id,span_before,span_after,facts_removed,similarity_score,status,failure_reason,created_at\nid-1,art-1,ent-1,mention,span-1,chunk-1,before,after,[],0.9,success,,2024-01-01\n"
