"""Tests for scripts.everycode.generate_code_config module."""
...
def _clear_cache() -> None:
    """Clear the find_project_root cache before each test."""
    clear_project_root_cache()
...
class TestResolveInstructionFile:
    """Tests for resolve_instruction_file function."""
...
class TestProcessCommand:
    """Tests for process_command function - instruction file resolution and merging."""
