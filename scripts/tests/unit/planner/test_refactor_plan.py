...
class TestNextActionErrorPhase:
    ...
    def test_error_phase_does_not_recurse(self, state_machine: Any, mock_state: MagicMock) -> None:
...
class TestProcessComponentAnalyzerPatternsUsed:
    ...
    def test_patterns_used_is_set_on_unit(self, state_machine: Any, mock_state: MagicMock) -> None:
