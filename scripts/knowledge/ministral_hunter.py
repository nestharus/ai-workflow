...
# Prompt templates
ENTITY_DISCOVERY_PROMPT = """You are an entity discovery agent. Find all entities \
...
FACT_EXTRACTION_PROMPT = """You are a fact extraction agent. Extract all explicit \
facts about the entity '{target_entity}' from the following text.
