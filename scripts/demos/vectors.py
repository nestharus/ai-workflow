...
fill = ax1.fill_between(t_smooth, angle_smooth, angle_smooth, color='red', alpha=0.3, label='The Cloud (Wobble)')
...
bar_container = ax2.bar(times[1:], np.diff(angles), color='green', alpha=0.6, width=0.3, label='Extracted Vectors')
