...
def _build_brief_extraction_prompt(lib_id: str, charter: str, spec: str) -> str:
    lines = [
        ...
        '      "citation": "[lib_001::spec.md::SECURITY]"',
        "    }",
        "  ],",
        '  "interfaces": [',
        "    {",
...
def _build_architecture_proposal_prompt(
    ...
    lines.extend(
        [
            ...
            '    "citations": ["[lib_001::charter.md]", "[lib_002::spec.md::API]"],',
            '    "tradeoffs": {',
...
def _build_architecture_selection_prompt(
    ...
    lines.extend(
        [
            ...
            '[lib_001::charter.md] [lib_002::spec.md::TRADEOFFS]",',
