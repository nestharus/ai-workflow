...
uv run spec.repair-bakeoff --output scripts/spec_refinement/evaluation/results/REPAIR_MODEL_SELECTION.md
```

## Fixtures
- Add fixtures to `scripts/spec_refinement/evaluation/fixtures/*.py` in the `FIXTURES` list.
