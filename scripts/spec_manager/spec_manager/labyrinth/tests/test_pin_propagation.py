...
class TestPropagation:
    ...
    def test_multiple_edges_for_same_change(self):
        ...
        edges = [
            _make_edge(edge_id="IMEDGE-0001", projection_type="pass_through",
                       arch_location="handler1.py:handle"),
            _make_edge(edge_id="IMEDGE-0002", projection_type="middleware_wrap",
                       arch_location="handler2.py:wrapped"),
            _make_edge(edge_id="IMEDGE-0003", projection_type="smear",
                       arch_location="handler3.py:combined"),
        ]
