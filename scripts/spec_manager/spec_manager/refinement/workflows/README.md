...
```python
from spec_manager.refinement.workflows import (
    sectionize_all,
    summarize_all,
...
- `scripts/spec_manager/spec_manager/refinement/workflows/evidence_expansion.py` - Reads section IDs from sections.json
