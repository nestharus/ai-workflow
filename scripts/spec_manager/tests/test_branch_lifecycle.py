...
class TestPhaseEnum:
    ...
    def test_get_next_phase_excludes_branch_phases(self) -> None:
        ...
        standard_phases = [
            Phase.INIT, Phase.SECTIONIZATION, Phase.SUMMARIZATION,
            Phase.LIBRARY_SYNTHESIS, Phase.EVIDENCE_EXPANSION,
            Phase.SPEC_BUILDING, Phase.SPEC_STABILIZATION,
            Phase.ALIGNMENT_CHECK, Phase.OVERVIEW_GENERATION,
            Phase.QA_EVALUATION, Phase.SUBLIBRARY_DETECTION,
            Phase.ARCHITECTURE_PROPOSAL, Phase.ARCHITECTURE_SELECTION,
            Phase.ARCHITECTURE_MAPPING, Phase.LIBRARY_STRUCTURE_REVIEW,
            Phase.INTERFACES, Phase.QUALITY_GATES, Phase.TASKS,
            Phase.IMPLEMENTATION, Phase.AUDIT,
        ]
...
class TestBranchWorkflowInit:
    ...
    def test_init_without_source_dir(self, workspace_dir: Path) -> None:
        ...
        with patch(
            "spec_manager.refinement.workflows.branch_lifecycle._get_manager"
        ) as mock_mgr:
    ...
    def test_init_with_source_dir(
        self, workspace_dir: Path, sample_source_dir: Path
    ) -> None:
...
class TestBranchWorkflowGaps:
    ...
    def test_gaps_after_init(self, tmp_path: Path) -> None:
        ...
        with patch(
            ...
            "spec_manager.branches.gap_detection.GapDetector"
