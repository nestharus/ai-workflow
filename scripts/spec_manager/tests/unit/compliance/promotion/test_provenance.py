...
class TestUpdateProvenanceFromRegistry:
    def test_new_functions_get_introduced_by(self) -> None:
        ...
        updated = update_provenance_from_registry(pin_registry, existing, modifier="initial_scan")
    ...
    def test_changed_function_gets_modification(self) -> None:
        ...
        updated = update_provenance_from_registry(pin_registry, existing, modifier="plan_002")
