...
class TestGatePasses:
    ...
    def test_passes_when_no_drift(self, tmp_path: Path) -> None:
        ...
        result = check_test_pin_alignment_gate(registry, [test_dir], baseline_path, gate_spec)
...
class TestCoverageThreshold:
    ...
    def test_fails_when_below_threshold(self, tmp_path: Path) -> None:
        ...
        coverage_findings = [f for f in result.findings if f.get("coverage_below_threshold")]
