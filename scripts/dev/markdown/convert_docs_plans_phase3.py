#!/usr/bin/env python3
"""Converter script for phase3.md.

Converts docs/plans/phase3.md to docs/plans/phase3.yml.
"""
...
def main() -> None:
    ...
    source = project_root / "docs/plans/phase3.md"
    target = project_root / "docs/plans/phase3.yml"
