---
name: test-fixer
description: Runs all tests, debugs failures, and ensures coverage requirements are met
model: claude-opus-4-5-thinking-high
tools: ["Read", "Edit", "MultiEdit", "Create", "Execute", "Grep", "Glob", "LS", "TodoWrite", "firecrawl_scrape", "firecrawl_search"]
---
