...
## Algorithm 32: CLOSE_WORKSPACE_CASCADE (structured lifetime)
...
## Algorithm 33: SPAWN_CHILD (fork-join)
...
## Algorithm 35: IMPORT_CAPSULE (idempotent)
...
## Algorithm 37: RECONCILE_CHILD_TO_PARENT
...
## Algorithm 38: COMMIT_TO_INGEST (no LLM diffs)
...
## Algorithm 39: OVERLAP_SIGNATURE (structure + content)
...
## Algorithm 41: OSCILLATION_SIGNAL
...
## P10.M1 Convergence-safe state model (event-set join)
...
## P10.M2 Workspace graph as a graph CRDT (optional mode)
...
## P10.M3 Delta-state replication for workspaces (optional)
...
## P10.M4 Overlap as near-duplicate detection
