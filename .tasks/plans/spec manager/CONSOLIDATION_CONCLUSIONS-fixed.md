...
PDD module implementations. The modules exist, are tested, and work — but the orchestrator ignores them.
...
* It should意识到 report grouping issues for human/system review
