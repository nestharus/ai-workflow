...
uv run python -m scripts.agents spec-planner --file workspace/execution/prompts/plan_001.md

# Implementation (uses Minimax for grunt work)
uv run python -m scripts.agents spec-implementor --file workspace/execution/prompts/implement_001.md

# Review (uses GPT-5.2-high for verification)
uv run python -m scripts.agents spec-reviewer --file workspace/execution/prompts/review_001.md
```
