---
description: Implements medium tasks (≤150 lines) using codex-max-high model
mode: subagent
...
This agent is automatically selected by apply_plan.py for tasks 71-150 lines. See implementor.md for routing documentation.
