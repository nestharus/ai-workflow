---
description: Implements small tasks (≤70 lines) using codex-max-medium model
mode: subagent
...
This agent is automatically selected by apply_plan.py for tasks ≤70 lines. See implementor.md for routing documentation.
