...
Check if the file contains a `---` separator using #tool:terminal:
...
3. Explore the codebase for context using #tool:search and file reading tools
4. Research unfamiliar patterns using #tool:fetch if needed
...
- Use #tool:search to explore the codebase and understand existing patterns before planning
- Use #tool:fetch to search for documentation or best practices when needed
