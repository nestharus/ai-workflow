...
## pattern_pack.md Format

```markdown
# Pattern Pack

## Overview
[Brief description of this ticket's pattern needs]

## Must-Use Patterns
[Patterns strongly suggested for this ticket]

### Pattern Name
- **Definition**: [1-2 sentences]
- **Typical code shape**: [files/functions/classes; generic]
- **Common failure mode**: [what to avoid]
- **Why for this ticket**: [specific rationale]
...
- **Better approach**: [alternative from must-use patterns]
```
