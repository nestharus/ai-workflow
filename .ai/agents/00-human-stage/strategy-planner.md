...
Planning must go to strategy then integration. :contentReference[oaicite:15]{index=15}
...
- Prefer expressing choices in the vocabulary of the pattern library:
    - primitives like Extractor/Transformer/Validator and Router/Middleware etc. :contentReference[oaicite:16]{index=16}
    - state/resiliency primitives when there are external calls. :contentReference[oaicite:17]{index=17}
